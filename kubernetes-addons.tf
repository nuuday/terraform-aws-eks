module "cilium" {
  ...
  source       = "github.com/nuuday/terraform-aws-eks-addons//modules/cilium?ref=v0.2.0"
...
module "prometheus" {
  ...
  source = "github.com/nuuday/terraform-aws-eks-addons//modules/prometheus?ref=v0.2.0"
...
module "kube-monkey" {
  source = "github.com/nuuday/terraform-aws-eks-addons//modules/kube-monkey?ref=v0.2.0"
  # source = "../terraform-aws-eks-addons/modules/kube-monkey"
  enable = var.kube_monkey_enable
}

module "metrics-server" {
  source = "github.com/nuuday/terraform-aws-eks-addons//modules/metrics-server?ref=v0.2.0"
...
module "aws-node-termination-handler" {
  source = "github.com/nuuday/terraform-aws-eks-addons//modules/aws-node-termination-handler?ref=v0.2.0"
